...
const EventFormPage = ({ addEvent }) => {
  const [formData, setFormData] = useState({
    ...
    description: '',
    total_amount: 0,
    date_event: '2006-01-02T15:04:05Z',
    status: 'done',
  ...
  const handleInputChange = (e) => {
    ...
    setFormData({
      ...formData,
      [name]: name === 'total_amount' ? parseInt(value, 10) || 0 : value, // Ensure total_amount is a number
    })
  }
      ...
      <section className='shadow-md rounded-md m-4 p-8 border'>
        ...
        <form className='grid grid-cols-6 gap-4 p-4' onSubmit={handleSubmit}>
          ...
          <TextareaForm
            ...
            onChange={handleInputChange}></TextareaForm>
