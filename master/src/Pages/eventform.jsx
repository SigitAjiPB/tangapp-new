        ...
        <>
            <section className="bg-white">
                <div className="lg:grid lg:grid-cols-12">
                    ...
                    <main
                    className="flex  bg-sky-50 justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6 border"
                    >
                    ...
                    <div className="flow-root justify-center px-6 py-6 sm:px-12 lg:col-span-7 lg:px-8 lg:py-6 xl:col-span-6 border">
