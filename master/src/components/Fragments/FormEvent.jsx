  ...
  // const events = useSelector((state) => state.event.events)
    ...
    return (
        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
            ...
            <Button 
            type='submit'  
            variant='col-span-4 bg-sky-400 w-full text-white font-bold sm:row-start-3 sm:col-span-2 hover:bg-sky-500 hover:shadow-md h-10 px-6 font-semibold rounded-lg'>
                Submit
            </Button>
